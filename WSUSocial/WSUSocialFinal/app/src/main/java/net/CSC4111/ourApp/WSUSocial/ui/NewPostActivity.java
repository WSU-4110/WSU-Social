...
import net.CSC4111.ourApp.WSUSocial.models.User;
...
import static net.CSC4111.ourApp.WSUSocial.Const.USERS;
...
public class NewPostActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private static final String APP_PATH_PACKAGE = "net.CSC4111.ourApp.WSUSocial";
