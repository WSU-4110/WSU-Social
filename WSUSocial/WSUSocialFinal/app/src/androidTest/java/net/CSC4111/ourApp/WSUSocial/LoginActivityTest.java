package net.CSC4111.ourApp.WSUSocial;
...
import net.CSC4111.ourApp.WSUSocial.ui.LoginActivity;
import net.CSC4111.ourApp.WSUSocial.ui.MainActivity;
...
public class LoginActivityTest {
    ...
    public void doubleClickTest() {
        onView(withId(R.id.email)).perform(replaceText("stas@CSC4111.net"));
